...
export class HelloClass extends React.Component <Props, State>{
    ...
    onIncrement = () => this.setState({currentEnthusiasm: this.state.currentEnthusiasm + 1})
    onDecrement = () => this.setState({currentEnthusiasm: this.state.currentEnthusiasm - 1})
    ...
    render(){
        ...
        return(
            <div className="hello">
                <div className="greeting">
                    Hello {this.props.name + getExclamationMark(this.state.currentEnthusiasm)}
                </div>
